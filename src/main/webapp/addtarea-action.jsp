...
<body>
    <%
        ...
        try{
            ...
            if(tareas.createtarea(newTareaData)==1){
                response.sendRedirect("tareas.jsp");
            }
            else{
                response.sendRedirect("tareas.jsp?error=No ha sido posible añadir la inforamción");
            }
        }catch (Exception e) {  
            out.print("Este nombre de tarea ya existe, por favor introduzca uno diferente");
        }
