    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <form method="POST" action="change-profile.jsp" class="p-3 border rounded shadow-sm">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" name="name" id="floatingInput" value="<% out.print(name); %>" >
          <label for="floatingInput">Nombre</label>
        </div>
        <div class="form-floating mb-3">
          <input type="text" class="form-control" name="surname" id="floatingPassword" value="<% out.print(surname); %>" >
          <label for="floatingPassword">Apellidos</label>
        </div>
        <div class="form-floating mb-3">
          <input type="text" class="form-control" name="username" id="floatingPassword" value="<% out.print(username); %>" >
