...
public class registro {
  ...
  "<main class=\"form-signin\">"+
    "<form id=\"registerForm\" method=\"POST\" action=\"doregistration.jsp\">"+
      "<h1 class=\"h3 mb-3 fw-normal\">Por favor regístrese</h1>"+
  
      "<div class=\"form-floating\">"+
        "<input type=\"text\" class=\"form-control\" name=\"name\" id=\"floatingInput1\" required>"+
        "<label for=\"floatingInput1\">Nombre</label>"+
        "<div id=\"nameError\" class=\"error\"></div>"+
      "</div>"+
      "<div class=\"form-floating\">"+
        "<input type=\"text\" class=\"form-control\" name=\"surname\" id=\"floatingInput2\" required>"+
        "<label for=\"floatingInput2\">Apellidos</label>"+
        "<div id=\"surnameError\" class=\"error\"></div>"+
      "</div>"+
      "<div class=\"form-floating\">"+
        "<input type=\"text\" class=\"form-control\" name=\"username\" id=\"floatingInput3\" required>"+
